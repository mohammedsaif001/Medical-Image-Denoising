const teamDetails = [
    ...
    {
        image: process.env.PUBLIC_URL + "images/abdullah.jpg",
    ...
    },
    {
        ...
        image: process.env.PUBLIC_URL + "images/saif.jpg",
    ...
    {
        image: process.env.PUBLIC_URL + "images/yunus.jpeg",
    ...
    {
        image: process.env.PUBLIC_URL + "images/uvais.jpg",
